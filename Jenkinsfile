                ...
                stage('api-gateway') {
                    steps {
                        withSonarQubeEnv(credentialsId: 'Conference_sonar', installationName: 'SonarQube') {
                            ...
                            ./sagateway/gradlew -b ./sagateway/build.gradle sonarqube -Dsonar.projectKey=api-gateway -Dsonar.organization=kyribamstraining -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=bbc606de8949bdabde5cb4f88bf29931c736d2b9
                            '''
                        }
                        sleep(10)
                        timeout(time: 3, unit: 'MINUTES') {
